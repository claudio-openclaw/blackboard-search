...
## Referencias
- Heurísticas UI: `references/blackboard-ui.md`.
- Guía técnica (Ultra stream + parse): `references/guide-ultra-stream.md`.

## Scripts
- `scripts/parse_activities.py` — JSON stream → Markdown (actividades)
- `scripts/README.md` — notas de uso

> Asistencia: pendiente de identificar endpoint/JSON específico de Ultra Attendance.
